                ...
                <div className="sidebarContainer bg-black bg-opacity-70 p-4">
                    <div className="sidebarDivContainer">
                        ...
                        <ul className="sidebarUl">
                            ...
                            <li>
                                <Link to="/workExample" className="sidebarElenco bg-transparent border border-gray-800 shadow-lg rounded-2xl p-4 transition ease-in duration-500  transform hover:scale-105" element={<HeroWorkEx/>}>
                            ...
                            <li>
                                <Link to="/notizie" className="sidebarElenco bg-transparent border border-gray-800 shadow-lg rounded-2xl p-4 transition ease-in duration-500  transform hover:scale-105" element={<HeroNews/>}>
