...
<div className="sidebarContainer bg-black p-4">
  <div className="sidebarDivContainer">
    ...
    <ul className="sidebarUl">
      ...
      <li>
        <Link to="/workExample" style={{ textDecoration: 'none' }} className="sidebarElenco bg-transparent border border-gray-800 shadow-lg rounded-2xl p-4 transition ease-in duration-500  transform hover:scale-105" element={<News/>}>
      ...
      <li>
        <Link to="/notizie" style={{ textDecoration: 'none' }} className="sidebarElenco bg-transparent border border-gray-800 shadow-lg rounded-2xl p-4 transition ease-in duration-500  transform hover:scale-105" element={<News/>}>
